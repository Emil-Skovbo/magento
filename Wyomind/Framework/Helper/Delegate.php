 ...
 */
namespace Wyomind\Framework\Helper;  class Delegate extends \Wyomind\Framework\Helper\License {public $xf0e5a=null;public $x43331=null;public $x5546f=null; const VERSION = "\65\56\63.\64"; public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, \Magento\Framework\App\Helper\Context $context) { parent::__construct($objectManager, $context); $this->constructor($this, func_get_args(), __CLASS__); } protected function getDelegation() { ${$this->x5546f->x36b6->{$this->xf0e5a->x36b6->x4ad8}} = "\\"; return [ ]; } }